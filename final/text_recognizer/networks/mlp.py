...
def mlp(input_shape: Tuple[int, ...],
    ...
    # reason for why we don't apply softmax at the last layer:
    # https://ai.stackexchange.com/questions/20214/why-does-tensorflow-docs-discourage-using-softmax-as-activation-for-the-last-lay
